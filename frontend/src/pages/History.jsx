...
// Fetch data dari API backend dengan pagination
...
export default function History() {
    const { history, removeRecord, clearHistory, totalRecords, fetchHistory,
            currentPage, totalPages, isLoading } = useHistory();
    ...
    return (
        <div className="container-app animate-fade-in">
            ...
            {/* Info notice - updated from in-memory warning to persistent storage confirmation */}
            <div className="mt-8 p-4 bg-blue-900/20 border border-blue-600/30 rounded-xl">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <p className="text-blue-500 font-medium text-sm">Penyimpanan Aman</p>
                        <p className="text-blue-600/80 text-sm mt-1">
                            Data riwayat scan Anda tersimpan secara permanen di server dan dapat diakses dari perangkat manapun.
                        </p>
                    </div>
                </div>
            </div>
